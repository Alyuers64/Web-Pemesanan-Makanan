        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/bg-satu.jpg">
                        <div class="hero__text">
                            <span>RESTO MEMORIAM</span>
                            <h2>Rasa <br />100% Original</h2>
                            <p>Restoran yang bisa pesan antar makanan</p>
                            <a href="shop-grid.php" class="primary-btn">ORDER NOW</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/ayam-bakar.jpg">
                            <h5><a href="shop-grid.php">Makanan Kekinian</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/teh-es.jpg">
                            <h5><a href="shop-grid.php">Minuman Segar</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/potato.jpg">
                            <h5><a href="shop-grid.php">Snack Ala Eropa</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/nasgor.jpg">
                            <h5><a href="shop-grid.php">Makanan Nusantara</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/red.jpg">
                            <h5><a href="shop-grid.php">Minuman Gaul</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cas.jpg">
                            <h5><a href="shop-grid.php">Snack No Ribet</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="img/blog/Kopi Latte.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> Mei 4,2023</li>
                                <li><i class="fa fa-heart-o"></i> 120</li>
                            </ul>
                            <h5><a href="#">Kopi Latte</a></h5>
                            <p>Kopi dengan campuran krim latte yang creamy membuat suasana menjadi lebih tenang </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="img/blog/steak.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> Mei 5,2023</li>
                                <li><i class="fa fa-heart-o"></i> 80</li>
                            </ul>
                            <h5><a href="#">Steak Sapi + Potato</a></h5>
                            <p>Steak sapi dengan tambahan ekstra snack kentang goreng membuat hidup menjadi komplit </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="img/blog/mie.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> Mei 9,2023</li>
                                <li><i class="fa fa-heart-o"></i> 76</li>
                            </ul>
                            <h5><a href="#">Mie Goreng</a></h5>
                            <p>Mie goreng dengan banyak toping membuat hidup menjadi lebih bervariasi </p>
                        </div>
                    </div>
                </div>
            </div>
